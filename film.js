const url = 'http://www.omdbapi.com/?i=tt0482571&apikey=c1d982c4';
        ...
        <div> 
             ...
             <div> 
                ...
                <br><hr><br>
                  ...
                  <li> <b>Gişe Hasılatı: </b>${movie.BoxOffice ? movie.BoxOffice : "Bilgi yok"}</li>
                  <li> <b>Ülke:  </b>${movie.Country}</li>
                  <li> <b>DVD:  </b>${movie.DVD ? movie.DVD : "Bilgi yok"}</li>
